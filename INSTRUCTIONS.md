...
You can see the latest releases in the Github repository at https://github.com/OurActivities/lunch/releases
...
Or go directly to https://www.npmjs.com/package/@ouractivities/lunch

To install the node module package use the following:

```
$ npm i @ouractivities/lunch
```
